    ...
    return (
        <div className="max-w-[1400px] mx-auto space-y-6 animate-fade-slide-up">
            <div>
                ...
                <p className="text-sm text-text-secondary mt-0.5">See how you stack up globally 🏆</p>
            </div>
            <div className="bg-white rounded-2xl border border-border shadow-card p-8 flex flex-col items-center justify-center text-center gap-3 min-h-[300px]">
                ...
                <h3 className="text-base font-semibold text-text-primary">Leaderboard coming soon</h3>
                <p className="text-sm text-text-secondary max-w-xs">
                    Rankings, XP comparisons, and weekly competition will live here.
                </p>
            </div>
        </div>
    );
